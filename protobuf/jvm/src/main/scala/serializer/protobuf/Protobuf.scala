...
//  }
  ...
  def toBase64String[@specialized T](v: T)(implicit serializer: Serializer[T]): String = {
    ...
    new String(Base64.getEncoder.encode(toBytes[T](v)), StandardCharsets.UTF_8)
  }
  ...
  def fromBase64String[@specialized T](str: String, options: ProtobufOptions)(implicit deserializer: Deserializer[T]): T = {
    ...
    // Base64.Decoder.decode uses ISO_8859_1 for strings by default
    // // new String(encode(src), StandardCharsets.ISO_8859_1)}.
    // Original Base64.decode used US_ASCII
    fromBytes[T](Base64.getDecoder.decode(str.getBytes(StandardCharsets.UTF_8)), options)
  }
  ...
  def toBase64URLSafeString[@specialized T](v: T)(implicit serializer: Serializer[T]): String = {
    ...
    new String(Base64.getUrlEncoder.encode(toBytes[T](v)), StandardCharsets.UTF_8)
  }
  ...
  def fromBase64URLSafeString[@specialized T](str: String, options: ProtobufOptions)(implicit deserializer: Deserializer[T]): T = {
    ...
    fromBytes[T](Base64.getUrlDecoder.decode(str.getBytes(StandardCharsets.UTF_8)), options)
  }
}
